...
EMAIL_ADDRESS = "samir.naji998@gmail.com"  # استبدل ببريدك الإلكتروني
EMAIL_PASSWORD = "nnxe bfzv yysy rucy"  # استبدل بكلمة مرور البريد أو استخدم كلمة مرور التطبيقات
RECIPIENT_EMAIL = "samirnaji.999@gmail.com"  # استبدل بالبريد الذي تريد إرسال الصور إليه
